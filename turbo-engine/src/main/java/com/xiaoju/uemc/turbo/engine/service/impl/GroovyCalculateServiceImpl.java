...
public class GroovyCalculateServiceImpl implements CalculateService {
    ...
    @Override
    public Boolean calculate(String expression, Map<String, Object> dataMap) throws Exception {
        ...
        if (result instanceof Boolean) {
            ...
            throw new ProcessException(ErrorEnum.GROOVY_CALCULATE_FAILED.getErrNo(), "表达式非bool类型");
        }
    }
}
